  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new A2 Code prerelease is available for nightly testers."
          : "A new A2 Code latest release is available.",
...
).pipe(Command.withDescription("Post an A2 Code release announcement to Discord."));
