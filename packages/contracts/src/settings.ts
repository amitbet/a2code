...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // The project-tree sidebar is the primary layout. Keep the persisted key for
  // compatibility with existing installations even though the UI no longer
  // presents this layout as a legacy feature.
