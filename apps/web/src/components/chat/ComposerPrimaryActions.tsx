...
import { ChevronDownIcon, ChevronLeftIcon, SendHorizontalIcon } from "lucide-react";
...
export const ComposerPrimaryActions = memo(function ComposerPrimaryActions({
  ...
  if (isRunning) {
    // Sending while a turn runs queues the prompt (fork queued-prompt steering),
    // so the running composer keeps an explicit Queue action beside Stop.
    return (
      <div className={cn("flex items-center justify-end", compact ? "gap-1.5" : "gap-2")}>
