...
describe("ComposerPrimaryActions", () => {
  ...
  // Fork behavior: sending while a turn runs queues the prompt, so the running
  // composer always offers Queue beside Stop — independent of whether
  // Enter-to-send is available on this viewport.
  it("renders queue alongside stop while running, regardless of Enter-to-send", () => {
    for (const showSendWhileRunning of [false, true]) {
      const markup = renderRunningActions(showSendWhileRunning, true);
