...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    createCloudAuthRequest: vi.fn().mockResolvedValue("a2code-dev://auth/callback?t3_state=test"),
...
describe("GeneralSettingsPanel observability", () => {
  ...
  it("shows a disabled network access toggle with guidance in desktop builds", async () => {
    ...
    await expect
      .element(page.getByText("A2 Code will restart to expose this environment over the network."))
      .toBeInTheDocument();
