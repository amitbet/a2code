...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  const explicitlyUnread = useUiStateStore((state) => state.unreadThreadIds[threadKey] ?? false);
  ...
  const isUnread = hasUnseenCompletion({ ...thread, lastVisitedAt, isUnread: explicitlyUnread });
