...
const updatesEnabled = repoEnv.T3CODE_MOBILE_UPDATES_ENABLED !== "0";
    ...
    widgets: [
      {
        ...
        // iOS-only widget. expo-widgets writes Android widget string resources
        // to res/xml/, which leaves the generated AndroidManifest references
        // unresolved during AAPT linking.
        android: null,
      },
    ],
  },
